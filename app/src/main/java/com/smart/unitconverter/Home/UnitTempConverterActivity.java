...
import com.smart.unitconverter.Adapter.ConverterTempAdapter;
...
import com.smart.unitconverter.objects.MyTempUnitConverter.MyUnit;
				...
				.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
					...
					public void onItemClick(QuickAction source, int pos,
						...
						if (actionItem.getActionId() == ID_ADD_UNIT) {
							...
							intent.putExtra("unit_type", MenuFragment.MenuItem.TEMPERATURE);
