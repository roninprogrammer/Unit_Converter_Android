...
import com.smart.unitconverter.Adapter.ConverterSpeedAdapter;
...
import com.smart.unitconverter.objects.MySpeedUnitConverter.MyUnit;
				...
				.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
					...
					public void onItemClick(QuickAction source, int pos,
						...
						if (actionItem.getActionId() == ID_ADD_UNIT) {
							...
							intent.putExtra("unit_type", MenuFragment.MenuItem.SPEED);
