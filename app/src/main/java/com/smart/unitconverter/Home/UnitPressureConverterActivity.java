...
import com.smart.unitconverter.Adapter.ConverterPressureAdapter;
...
import com.smart.unitconverter.objects.MyPressureUnitConverter.MyUnit;
				...
				.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
					...
					public void onItemClick(QuickAction source, int pos,
						...
						if (actionItem.getActionId() == ID_ADD_UNIT) {
							...
							intent.putExtra("unit_type", MenuFragment.MenuItem.PRESSURE);
