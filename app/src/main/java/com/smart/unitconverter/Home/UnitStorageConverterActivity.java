...
import com.smart.unitconverter.Adapter.ConverterStorageAdapter;
...
import com.smart.unitconverter.objects.MyStorageUnitConverter.MyUnit;
					...
					public void onItemClick(QuickAction source, int pos,
						...
						if (actionItem.getActionId() == ID_ADD_UNIT) {
							...
							intent.putExtra("unit_type",
									MenuFragment.MenuItem.DIGITAL_STORAGE);
