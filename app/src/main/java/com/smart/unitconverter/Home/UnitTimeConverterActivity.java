...
import com.smart.unitconverter.Adapter.ConverterTimeAdapter;
...
import com.smart.unitconverter.objects.MyTimeUnitConverter.MyUnit;
				...
				.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
					...
					public void onItemClick(QuickAction source, int pos,
						...
						if (actionItem.getActionId() == ID_ADD_UNIT) {
							...
							intent.putExtra("unit_type", MenuFragment.MenuItem.TIME);
