...
import com.smart.unitconverter.Adapter.ConverterAreaAdapter;
import com.smart.unitconverter.R;
import com.smart.unitconverter.dslv.DragSortListView;
import com.smart.unitconverter.objects.MyAreaUnitConverter;
				...
				.setOnActionItemClickListener(new QuickAction.OnActionItemClickListener() {
					...
					public void onItemClick(QuickAction source, int pos,
						...
						if (actionItem.getActionId() == ID_ADD_UNIT) {
							...
							intent.putExtra("unit_type", MenuFragment.MenuItem.AREA);
	...
	public void onBackPressed()
	{
		...
		else
		{
			...
			Snackbar.with(getApplicationContext()) // context
					.text("Double Tap to exit") // text to display
